...
RUNTIME_POLICY_VERSION = os.getenv("AMP_RUNTIME_POLICY_VERSION", "runtime-v1")
RETRY_POLICY_VERSION = os.getenv("AMP_RETRY_POLICY_VERSION", "retry-v1")
HISTORY_POLICY_VERSION = os.getenv("AMP_HISTORY_POLICY_VERSION", "recent-v1")
RUNTIME_MAX_SECONDS = int(os.getenv("AMP_RUNTIME_MAX_SECONDS", "120"))
RUNTIME_MAX_STEPS = int(os.getenv("AMP_RUNTIME_MAX_STEPS", "12"))
RUNTIME_MAX_TOOL_CALLS = int(os.getenv("AMP_RUNTIME_MAX_TOOL_CALLS", "4"))
RUNTIME_MODEL_TIMEOUT_SECONDS = int(os.getenv("AMP_RUNTIME_MODEL_TIMEOUT_SECONDS", "45"))
RUNTIME_TOOL_TIMEOUT_SECONDS = int(os.getenv("AMP_RUNTIME_TOOL_TIMEOUT_SECONDS", "10"))
RUNTIME_MAX_OUTPUT_CHARS = int(os.getenv("AMP_RUNTIME_MAX_OUTPUT_CHARS", "8000"))
HISTORY_MAX_MESSAGES = int(os.getenv("AMP_HISTORY_MAX_MESSAGES", "20"))
HISTORY_MAX_ESTIMATED_TOKENS = int(os.getenv("AMP_HISTORY_MAX_ESTIMATED_TOKENS", "6000"))
WORKER_STALE_SECONDS = int(os.getenv("AMP_WORKER_STALE_SECONDS", "45"))
HEALTH_CACHE_SECONDS = float(os.getenv("AMP_HEALTH_CACHE_SECONDS", "5"))
